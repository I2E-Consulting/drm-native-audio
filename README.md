...
```typescript
loadAzureDRMSoundURL(options: { audioURL: String; authorName: String; title: String; notificationThumbnail: String; seekTime: number; token: String; }) => Promise<void>
```

| Param         | Type                                                                                                                                                                                                                                                |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ audioURL: <a href="#string">String</a>; authorName: <a href="#string">String</a>; title: <a href="#string">String</a>; notificationThumbnail: <a href="#string">String</a>; seekTime: number; token: <a href="#string">String</a>; }</code> |
